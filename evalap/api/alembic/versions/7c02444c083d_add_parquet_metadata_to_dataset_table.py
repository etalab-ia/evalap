...
def upgrade() -> None:
    ...
    op.execute(sa.text("UPDATE datasets SET parquet_size= 0 WHERE parquet_size IS NULL"))
    op.execute(sa.text("UPDATE datasets SET parquet_columns = '[]' WHERE parquet_columns IS NULL"))
