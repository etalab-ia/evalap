...
class TemplateManager:
    ...
    def render_python(self, name: str, readme: str | None = None, experiments: list | None = None, cv: dict | None = None) -> str:
    ...
    def render_curl(self, name: str, readme: str | None = None, experiments: list | None = None, cv: dict | None = None) -> str:
